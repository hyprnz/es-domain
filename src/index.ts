...
export * from './writeModelRepository/SnapshotWriteModelRepository'
...
export { SnapshotWriteModelRepository } from './writeModelRepository/SnapshotWriteModelRepository'
