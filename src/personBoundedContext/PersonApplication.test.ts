...
describe('personApplication', () => {
  ...
  // Setup Write side
  const personWriteRepository = new AggregateRootRepository(new InMemoryEventStoreRepository())
  personWriteRepository.subscribeToChangesSynchronously(eventBus)
