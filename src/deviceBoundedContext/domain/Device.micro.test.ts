...
import { UNINITIALISED_AGGREGATE_VERSION, ChangeEvent, EntityEvent, OldEntity } from '../../EventSourcing/EventSourcingTypes'
...
describe('Device', () => {
  ...
  const makeEntityMatcher = (entity: OldEntity) => match.obj.has({ id: entity.id })
})