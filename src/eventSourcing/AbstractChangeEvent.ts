...
export abstract class AbstractChangeEvent implements ChangeEvent {
  ...
  protected constructor(
    ...
    public readonly aggregateRootId: Uuid.UUID,
    public readonly entityId: Uuid.UUID,
    public dateTimeOfEvent = new Date().toISOString()
  ) {
...
export type ChangeEventConstructor<E extends AbstractChangeEvent> = {
  ...
  new (aggregateRootId: Uuid.UUID, entityId: Uuid.UUID, payload: E['payload']): E
}
